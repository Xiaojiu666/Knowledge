...
package com.gx.base.themeswitcher;
...
public class ThemeSwitcherDialogFragment extends BottomSheetDialogFragment {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        themeAttributeValuesCreator = new ThemeAttributeValuesCreator();
    }
    ...
    private int getThemeOverlayResId(RadioGroup radioGroup) {
        ...
        ThemeAttributeValuesCreator.ThemeAttributeValues overlayFeature =
                (ThemeAttributeValuesCreator.ThemeAttributeValues)
