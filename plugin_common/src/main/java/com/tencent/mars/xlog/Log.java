...
public class Log {
    ...
    public static void f(String tag, final String format, final Object... obj) {
        if (logImp != null) {
            ...
            final StackTraceElement ste = Thread.currentThread().getStackTrace()[5];
            logImp.logF(tag, ste.getFileName(), ste.getMethodName(), ste.getLineNumber(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void e(String tag, final String format, final Object... obj) {
        if (logImp != null) {
            ...
            final StackTraceElement ste = Thread.currentThread().getStackTrace()[5];
            logImp.logE(tag, ste.getFileName(), ste.getMethodName(), ste.getLineNumber(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void w(String tag, final String format, final Object... obj) {
        if (logImp != null) {
            ...
            final StackTraceElement ste = Thread.currentThread().getStackTrace()[5];
            logImp.logW(tag, ste.getFileName(), ste.getMethodName(), ste.getLineNumber(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void i(String tag, final String format, final Object... obj) {
        if (logImp != null) {
            ...
            final StackTraceElement ste = Thread.currentThread().getStackTrace()[5];
            logImp.logI(tag, ste.getFileName(), ste.getMethodName(), ste.getLineNumber(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void d(String tag, final String format, final Object... obj) {
        if (logImp != null) {
            ...
            final StackTraceElement ste = Thread.currentThread().getStackTrace()[5];
            logImp.logD(tag, ste.getFileName(), ste.getMethodName(), ste.getLineNumber(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void v(String tag, final String format, final Object... obj) {
        if (logImp != null) {
            ...
            final StackTraceElement ste = Thread.currentThread().getStackTrace()[5];
            logImp.logV(tag, ste.getFileName(), ste.getMethodName(), ste.getLineNumber(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
